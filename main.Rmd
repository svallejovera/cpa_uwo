...
5. Label a sample of your data (N=75; decide how you will sample the data and explain your decision). Have a classmate label the same sample. Estimate [inter-coder reliability](http://www.cookbook-r.com/Statistical_analysis/Inter-rater_reliability/) and [evaluate the results](https://statisticsbyjim.com/hypothesis-testing/inter-rater-reliability/).
