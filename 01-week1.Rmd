...
year during his productive," and that one of these characteristics was the length of words. Mendenhall (1901) takes this further, and suggests that, given this assumption, Shakespeare and Bacon were *not* the same person[^1].
...
words %>%
  ...
  geom_point(alpha=0.8) +
  geom_line(alpha=0.8) +
  scale_color_viridis_d(option="E",alpha = 0.8) +
...
[^1] These studies were published in Science and Popular Science Monthly!
